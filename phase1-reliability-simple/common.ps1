...
$script:StagedFiles = [ordered]@{
    "ACTIVE.PKT" = "b58d7cbeae0545cfaa5e0de3c9028ca18d98d3b4dd841f1f5934a0f3e298a58c"
    "PENDING.PKT" = "28d2d032667f272ea64a9698bf9eb3d277485d96dc8148d60f954fb89a0a4859"
    "LASTGOOD.PKT" = "d489c03fdfbbdffc2e15922bdd185ce8b07d7722061a8516392162c151664735"
    "STATE0.BIN" = "54790fdff256da8bea3657cc263049265a0054345877a26b5c47c985d5b9f72f"
    "STATE1.BIN" = "9e023435957d8fcc0b5c918e5ff07f54c91ff92c455ad70fde249bc43fea9ffe"
}
...
function Get-LineageState {
    ...
    if ($state.schema -ne 1 -or $state.transaction -ne "phase1-reliability") {
...
function Start-LineageTransaction {
    ...
    try {
        ...
        $state = [ordered]@{
            schema = 1
            transaction = "phase1-reliability"
            phase = "snapshot"
