...
$script:CandidateName = "pocketjs-a1099-phase1-native-kernel.ipod"
$script:CandidateSha256 = "75538890c9328a5fc3c4c718b49c40611af26f3ab0f4a43f5132fd3e954cc69c"
$script:TransactionName = ".pocketjs-native-kernel-state.json"
$script:BackupName = ".pocketjs-native-kernel-backup"
$script:ManagedFiles = @(
...
function Get-LineageState {
    ...
    if ($state.schema -ne 1 -or $state.transaction -ne "phase1-native-kernel") {
...
function Start-LineageTransaction {
    ...
    try {
        ...
        $state = [ordered]@{
            schema = 1
            transaction = "phase1-native-kernel"
            phase = "snapshot"
