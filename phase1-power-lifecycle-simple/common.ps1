...
$script:CandidateName = "pocketjs-a1099-phase1-power-lifecycle.ipod"
$script:CandidateSha256 = "b9d9a4a0a162419adc36dd6474b45aaa772b6dd703f554e8da7edf6514e971b3"
$script:TransactionName = ".pocketjs-power-lifecycle-state.json"
$script:BackupName = ".pocketjs-power-lifecycle-backup"
$script:ManagedFiles = @(
...
function Get-LineageState {
    ...
    if ($state.schema -ne 1 -or $state.transaction -ne "phase1-power-lifecycle") {
...
function Start-LineageTransaction {
    ...
    try {
        ...
        $state = [ordered]@{
            schema = 1
            transaction = "phase1-power-lifecycle"
            phase = "snapshot"
