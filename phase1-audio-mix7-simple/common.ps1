...
$script:CandidateName = "pocketjs-a1099-phase1-audio-mix7.ipod"
$script:CandidateSha256 = "f39611516b7c1602628f4e86820ad8147a3e4dc633f985d9aeb2c1b557007a8b"
$script:TransactionName = ".pocketjs-audio-mix7-state.json"
$script:BackupName = ".pocketjs-audio-mix7-backup"
$script:ManagedFiles = @(
...
function Get-LineageState {
    ...
    if ($state.schema -ne 1 -or $state.transaction -ne "phase1-audio-mix7") {
